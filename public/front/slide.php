...
<body class="defult-home">
    ...
    <div class="main-content">
        ...
        <div class="rs-gallery pt-100 pb-100 md-pt-70 md-pb-70 mt-5">
            <div class="page-title">Slaydlar</div>
            <div class="container mt-5">
                <div class="row">
                    <div class="col-lg-4 mb-30 col-md-6">
                        <a class="" href="video-post.php">
                            <div class="">
                                <img src="assets/images/slayd-page.jpg" alt="">
                            </div>
                    ...
                    <div class="col-lg-4 mb-30 col-md-6">
                        <a class="" href="video-post.php">
                            <div class="">
                                <img src="assets/images/slayd-page-2.jpg" alt="">
                            </div>
                            <div class="gallery-title">
                    ...
                    <div class="col-lg-4 mb-30 col-md-6">
                        <a class="" href="video-post.php">
                            <div class="">
                                <img src="assets/images/slayd-page-3.jpg" alt="">
                            </div>
                            <div class="gallery-title">
                                Gənclərlə görüş
                            </div>
