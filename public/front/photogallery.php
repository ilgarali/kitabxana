...
<body class="defult-home">
    ...
    <div class="main-content">
        ...
        <div class="rs-gallery pt-100 pb-100 md-pt-70 md-pb-70 mt-5">
            <div class="page-title">Fotoqalereya</div>
            <div class="container mt-5">
                <div class="row">
                    <div class="col-lg-4 mb-30 col-md-6">
                        <a class="" href="photo-inner.php">
                            <div class="">
                                <img src="assets/images/gallery/gallery-1.jpg" alt="">
                            </div>
                            <div class="gallery-title">
                                164 nömrəli tam orta məktəbin şagirdləri F.Köçərli adına Respublika Uşaq Kitabxanasına
                                ekskursiya etdilər
                            </div>
                        </a>
                    </div>
                    <div class="col-lg-4 mb-30 col-md-6">
                        <a class="" href="photo-inner.php">
                            ...
                            <div class="gallery-title">
                                Məktəblilərin ekskursiyası
                            </div>
                        </a>
                    </div>
                    <div class="col-lg-4 mb-30 col-md-6">
                        <a class="image-popup" href="photo-inner.php">
