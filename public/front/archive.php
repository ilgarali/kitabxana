    ...
    <div class="main-content">
        <div class="container" style="margin-top: 150px; padding-bottom: 100px">
            <div class="page-title">
                Saytın köhnə variantı
            </div>
            <div class="d-flex justify-content-center mt-5">
                <div class="archive">
                    <a href="http://clb.az/arsiv/indexb.html"><img src="assets/images/archive-1.jpg" width="100%" alt=""></a>
                </div>
                <div class="archive ml-4">
                    <a href="http://clb.az/"><img src="assets/images/archive-2.jpg" width="100%" alt=""></a>
                </div>
            </div>
        </div>
    </div>
