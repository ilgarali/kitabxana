...
<body class="defult-home">
    ...
    <div class="main-content">
        ...
        <div class="rs-event modify1 orange-color pt-100 pb-100 md-pt-70 md-pb-70">
            <div class="page-title">Layihələrimiz</div>
                ...
                <div class="row">
                        ...
                        <div class="event-item">
                            <div class="event-short">
                                <div class="featured-img">
                                    <a href="project-inner.php"><img src="assets/images/newbook.jpg" alt="Image"></a>
                                </div>
                                <div class="content-part">
                                    <h4 class="title"><a href="newbook-inner.php">Böyük yaşlı oxucular üçün
                                            ədəbiyyat</a></h4>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-4 mb-30 col-md-6">
                        <div class="event-item">
                            <div class="event-short">
                                <div class="featured-img">
                                    <a href="project-inner.php"><img src="assets/images/newbook-2.jpg" alt="Image"></a>
                                </div>
                                <div class="content-part">
                                    <h4 class="title"><a href="#">Kiçik yaşlı oxucular üçün ədəbiyyat</a></h4>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 mb-30 col-md-6">
                        <div class="event-item">
                            <div class="event-short">
                                <div class="featured-img">
                                    <a href="project-inner.php"><img src="assets/images/newbook-3.jpg" alt="Image"></a>
                                </div>
                                <div class="content-part">
                                    <h4 class="title"><a href="#">Kiçik yaşlı oxucular üçün Brayl əlifbalı kitablar</a>
                                    </h4>
                                </div>
                            </div>
                        </div>
