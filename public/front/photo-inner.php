    ...
    <div class="main-content">
        ...
        <div class="rs-gallery pt-100 pb-100 md-pt-70 md-pb-70 mt-5">
            <div class="container mt-5">
                <div class="" style="font-size: 30px">193 nömrəli məktəbin kitabxanada tədbiri</div>
                <div class="row mt-5">
                    <div class="col-lg-2 mb-30 col-md-6 gallery-img">
                        <a class="image-popup" href="assets/images/gallery/gallery-1.jpg">
                            <div class="">
                    ...
                    <div class="col-lg-2 mb-30 col-md-6 gallery-img">
                        <a class="image-popup" href="assets/images/gallery/gallery-2.jpg">
                            <div class="">
                    ...
                    <div class="col-lg-2 mb-30 col-md-6 gallery-img">
                        <a class="image-popup" href="assets/images/gallery/gallery-3.jpg">
