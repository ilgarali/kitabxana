    ...
    <div class="main-content">
        ...
        <div class="rs-gallery pt-100 pb-100 md-pt-70 md-pb-70 mt-5">
            <div class="container mt-5">
                <div class="page-title">Audio-lətifələr</div>
                <div class="row mt-5">
                    <div class="col-lg-4 mb-30 col-md-6">
                        <a class="" href="video-post.php">
                            ...
                            <div class="gallery-title">
                                <a href="cd-inner.php">Ac göz ayı balaları</a>
                            </div>
                        </a>
                    </div>
                    <div class="col-lg-4 mb-30 col-md-6">
                        <a class="" href="video-post.php">
                            <div class="">
                                <img src="assets/images/cd-2.jpg" alt="">
                            </div>
                            <div class="gallery-title">
                                <a href="">Aldanmış canavar</a>
                            </div>
                        </a>
                    </div>
                    <div class="col-lg-4 mb-30 col-md-6">
                        <a class="" href="video-post.php">
                            <div class="">
                                <img src="assets/images/cd-3.jpg" alt="">
                            </div>
                            <div class="gallery-title">
                                <a href="">At və Canavar</a>
                            </div>
                        </a>
                    </div>
                    <div class="col-lg-4 mb-30 col-md-6">
                        <a class="" href="video-post.php">
                            <div class="">
                                <img src="assets/images/cd-4.jpg" alt="">
                            </div>
                            <div class="gallery-title">
                                <a href="">Canavar və Durna</a>
                            </div>
                        </a>
                    </div>
                    <div class="col-lg-4 mb-30 col-md-6">
                        <a class="" href="video-post.php">
                            <div class="">
                                <img src="assets/images/cd-5.jpg" alt="">
                            </div>
                            <div class="gallery-title">
                                <a href="">Cırtdan</a>
                            </div>
                    ...
                    <div class="col-lg-4 mb-30 col-md-6">
                        <a class="" href="video-post.php">
                            <div class="">
                                <img src="assets/images/cd-6.jpg" alt="">
                            </div>
                            <div class="gallery-title">
                                <a href="">Ən böyük var-dövlət</a>
                            </div>
                        </a>
                    </div>
                </div>
