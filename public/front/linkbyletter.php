                ...
                <div class="blog-deatails">
                    <div class="blog-full">
                        ...
                        <div class="blog-desc mt-5">
                            <div>1
                                <a href="">Amanova S.- Su satan Abbas</a>
                            </div>
                            <div>2
                                <a href="">Azərbaycan xalçaları Qarabağ inciləri</a>
                            </div>
                            <div>3
                                <a href="">Amanova Solmaz - İnsan iz qoyur</a>
                            </div>
                            <div>4
                                <a href="">Azərbaycan bayrağı</a>
                            </div>
                            <div>6<a href="">Elxan Elatlı - Qisas Gecesi</a></div>
                            <div>7<a href="">Elxan Elatlı - Голос из ада</a></div>
                            <div>8<a href="">Erməni terroru</a></div>
                        </div>
                    </div>
                </div>
            </div>
