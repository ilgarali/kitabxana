    ...
    <div class="main-content">
        ...
        <div class="rs-gallery pt-100 pb-100 md-pt-70 md-pb-70 mt-5">
            <div class="container">
                <div class="d-flex">
                    <div>
                        <div class="">GÖZƏLLİK MÜCƏSSƏMƏSİ: Leyla Bədirbəyli – 100</div>
                        <div>
                            <span class="mt-4 d-block">
                                <a href="" type="submit" class="readon submit-btn text-center">Yüklə</a>
                            </span>
                        </div>
                    </div>
                    <div class="ml-5">
                        <img src="assets/images/buklet-1.jpg" alt="">
                    </div>
                </div>
            </div>
        </div>
