                ...
                <div class="row">
                        ...
                        <div class="event-item">
                            <div class="event-short">
                                <div class="featured-img">
                                    <a href="newbook-inner.php"><img src="assets/images/newbook.jpg" alt="Image"></a>
                                </div>
                    ...
                    <div class="col-lg-4 mb-30 col-md-6">
                        <div class="event-item">
                            <div class="event-short">
                                <div class="featured-img">
                                    <img src="assets/images/newbook-2.jpg" alt="Image">
                                    <!-- <div class="dates">
                                        July 24, 2020
                                    </div> -->
                                </div>
                    ...
                    <div class="col-lg-4 mb-30 col-md-6">
                        <div class="event-item">
                            <div class="event-short">
                                <div class="featured-img">
                                    <img src="assets/images/newbook-3.jpg" alt="Image">
                                    <!-- <div class="dates">
                                        July 24, 2020
                                    </div> -->
                                </div>
                    ...
                    <div class="col-lg-4 mb-30 col-md-6">
                        <div class="event-item">
                            <div class="event-short">
                                <div class="featured-img">
                                    <img src="assets/images/newbook.jpg" alt="Image">
                                    <!-- <div class="dates">
                                        July 24, 2020
                                    </div> -->
                                </div>
